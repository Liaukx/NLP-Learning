...
if __name__ == '__main__':
    paths = ["task2_robert_alldata_1005","task2_bert_alldata_1005","task2_bert_wwm_alldata_1005","task2_bert_wwm_ex_alldata_1005"]
    label = pd.read_csv("../data_final/task2/task2_train.csv")["label"]
    out = []
    train_out = []
    for path in paths:
