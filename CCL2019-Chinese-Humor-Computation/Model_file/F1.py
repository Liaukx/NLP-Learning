...
if __name__ == '__main__':
    paths = ["task1_bert_alldata_1005","task1_robert_alldata_1005","task1_bert_wwm_alldata_1005","task1_bert_wwm_ex_alldata_1005"]
    # paths = ["task1_robert_alldata_1005"]
    label = pd.read_csv("../data_final/task1/task1_train.csv")["label"]
    out = []
    train_out = []
    for path in paths:
    ...
    df[["id","label"]].to_csv("task1_unite7_F1:{}.csv".format(round(f1_score(label,train_final),5)),index=None)